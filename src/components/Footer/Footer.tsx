            ...
            border-t-2 border-gray-300/10 text-white'>
                ...
                <div className='py-8 px-4 space-y-4 '>
                    ...
                    <p>
                        ...
                        elit. Ab placeat quaerat doloribus odit perferendis autem blanditiis, 
                ...
                md:col-span-3 md:ml-14'>
                    <div className='py-8 px-4'>
                        ...
                        sm:text-left text-justify mb-5'>Important Links</h1>
                    ...
                    <div className='py-8 px-4'>
                        <h1 className='sm:text-xl text-xl font-bold
                        sm:text-left text-justify mb-5'>Company Links</h1>
                        <ul className='flex flex-col gap-4'>
                            <li>
                    ...
                    <div className='py-8 px-4'>
                        <h1 className='sm:text-xl text-xl font-bold
                        sm:text-left text-justify mb-5'>Resources</h1>
                        <ul className='flex flex-col gap-4'>
                            <li>
                                <a href="#">Home</a>
                            </li>
